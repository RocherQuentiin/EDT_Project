...
INSERT INTO Horaire (date, heureDebut, heureFin) VALUES
  ...
  ('2023-11-22', '08:00:00', '10:00:00'),
  ('2023-11-22', '10:20:00', '12:20:00'),
  ('2023-11-22', '13:30:00', '15:30:00'),
  ('2023-11-23', '09:00:00', '11:00:00'),
  ('2023-11-23', '11:15:00', '13:15:00'),
  ('2023-11-24', '14:00:00', '16:00:00'),
  ('2023-11-24', '16:15:00', '18:15:00'),
  ('2023-11-25', '09:00:00', '11:00:00'),
  ('2023-11-25', '11:15:00', '13:15:00');
...
INSERT INTO Cours_Etudiant (cours_id, etudiant_id) VALUES
  (1, 8), (2, 8), (3, 9), (4, 9), (5, 8),
  (4, 10), (5, 10), (6, 11), (7, 12), (8, 10),
  (9, 11), (10, 12),
  (11, 13), (12, 14), (1, 13), (2, 14), (3, 13), (4, 14);
...
INSERT INTO Notification (message, destinataire_id, dateEnvoi, expediteur_id) VALUES
  ('Votre cours de Mathématiques a été déplacé.', 8, '2023-11-19 10:00:00', 1),
  ("Votre cours d\'Informatique est confirmé.", 8, '2023-11-19 11:00:00', 1),
  ('Votre cours de Physique est annulé.', 9, '2023-11-20 08:00:00', 1),
  ("Nouveau cours d\'Electronique ajouté.", 13, '2023-11-21 09:00:00', 1),
  ('Votre emploi du temps a été mis à jour.', 14, '2023-11-21 10:00:00', 1);
